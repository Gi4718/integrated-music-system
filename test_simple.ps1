...
Write-Host "登录成功，Token: $($loginResult.token.Substring(0,50))..." -ForegroundColor Green
$token = $loginResult.token

Write-Host "`n2. 获取当前设置" -ForegroundColor Cyan
...
Write-Host "`n3. 测试 resume_downloads 开关" -ForegroundColor Cyan
...
Write-Host "`n4. 测试 delete_removed 开关" -ForegroundColor Cyan
...
Write-Host "`n5. 测试 sync_mode 定时模式" -ForegroundColor Cyan
...
Write-Host "`n6. 测试下载功能" -ForegroundColor Cyan
...
Write-Host "`n7. 查看下载历史" -ForegroundColor Cyan
